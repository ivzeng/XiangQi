...
void Msg_XQ::init() {
    ...
    msgs[0][MTYPE_Board] = {{"", "━━", "┃", "┏", "┓", "┗", "┛", "┣", "┫", "┳", "┻", "╋"}, {"J", "S", "G", "P", "M", "X", "B"}, {"j", "s", "g", "p", "m", "x", "b"},  {"red", "black"}, {"\033[31m", "\033[30m", "\033[43m", "\033[0m"}};
    ...
    msgs[0][MTYPE_Proc][CMD_ToPS] = {"Game started.\nPlayers:"};
    msgs[0][MTYPE_Proc][CMD_ResetP] = {"Resetted players.\n"};
    msgs[0][MTYPE_Proc][CMD_Undo] = {"You are at the beginning of the game.\n", "undoing ", "...\n"};
    msgs[0][MTYPE_Proc][msgs[0][MTYPE_Proc].size()-1] = {"Invalid command!\n"};



    // cn
    msgs[1][MTYPE_Board] = {{" ", "━━", "┃", " ┏", "━┓", " ┗", "━┛", " ┣", "━┫", "━┳", "━┻", "━╋"}, {"将", "士", "车", "炮", "马", "相", "兵"}, {"将", "士", "车", "炮", "马", "象", "卒"}, {"红", "黑"}, {"\033[31m", "\033[30m", "\033[43m", "\033[0m"}};
    ...
    msgs[1][MTYPE_Proc][CMD_ToPS] = {"对局开始...\n双方:"};
    msgs[1][MTYPE_Proc][CMD_ResetP] = {"双方已重置。\n"};
    msgs[1][MTYPE_Proc][CMD_Undo] = {"重做失败: 未有走棋。\n", "返回上一步[", "]...\n"};
    msgs[1][MTYPE_Proc][msgs[0][MTYPE_Proc].size()-1] = {"无效指令, 请重试。\n"};
}
