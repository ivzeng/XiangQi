...
void Msg_XQ::init() {
    ...
    msgs[1][MTYPE_Board] = {{"", "━━", "┃", "┏", "┓", "┗", "┛", "┣", "┫", "┳", "┻", "╋"}, {"J", "S", "G", "P", "M", "X", "B"}, {"j", "s", "g", "p", "m", "x", "b"},  {"red", "black"}, {"\033[31m", "\033[30m", "\033[43m", "\033[0m"}};

    msgs[1][MTYPE_State] = vector<vector<string>>(6);
    msgs[1][MTYPE_State][STATE_Main] = {"XiangQI\nMain Menu: \n"};
    msgs[1][MTYPE_State][STATE_Setting] = {"Setting: \n"};
    msgs[1][MTYPE_State][STATE_PSetting] = {"Setting Player (", "): \n"};
    msgs[1][MTYPE_State][STATE_Game] = {"\nRound ", ",\nPlayer(", ") move:\n", "Player(", ") wins!\n"};

    msgs[1][MTYPE_Proc] = vector<vector<string>>(25);
    msgs[1][MTYPE_Proc][CMD_End] = {"Exits.\n"};
    msgs[1][MTYPE_Proc][CMD_ToPS] = {"Game started.\nPlayers:"};
    msgs[1][MTYPE_Proc][CMD_ResetP] = {"Resetted players.\n"};
    msgs[1][MTYPE_Proc][CMD_Undo] = {"You are at the beginning of the game.\n", "undoing ", "...\n"};
    msgs[1][MTYPE_Proc][msgs[1][MTYPE_Proc].size()-1] = {"Invalid command!\n"};


    // Texts in Chinese
    msgs[0][MTYPE_Board] = {{" ", "━━", "┃", " ┏", "━┓", " ┗", "━┛", " ┣", "━┫", "━┳", "━┻", "━╋"}, {"帅", "士", "车", "炮", "马", "相", "兵"}, {"将", "士", "车", "炮", "马", "象", "卒"}, {"红", "黑"}, {"\033[31m", "\033[30m", "\033[43m", "\033[0m"}};
